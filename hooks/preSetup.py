...
def on_startup(command, dirty:bool):
	...
	# 'CF_PAGES' comes from https://developers.cloudflare.com/pages/platform/build-configuration/#environment-variables
	# 'CI' comes from https://docs.github.com/en/actions/learn-github-actions/variables#default-environment-variables
	if ((os.getenv('CF_PAGES') != None and bool(os.getenv('CF_PAGES'))) or (os.getenv('CI') != None and bool(os.getenv('CI')))):
		if platform == "linux":
